...
Buffers were removed in favor of using Uin8Arrays for greater compatibility with browsers.
...
- Fix karma, readme updates, move utils to own file. PR [#109](https://github.com/ethereumjs/rlp/pull/109)
